...
<head>
	...
	<!-- CSS Libraries -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/admin/modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
	<link rel="stylesheet" href="<?= base_url(); ?>assets/admin/modules/datatables.net-select-bs4/css/select.bootstrap4.min.css">
	...
	<!-- JS Libraies -->
	<script src="<?= base_url(); ?>assets/admin/modules/datatables/media/js/jquery.dataTables.min.js"></script>
	<script src="<?= base_url(); ?>assets/admin/modules/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
	<script src="<?= base_url(); ?>assets/admin/modules/datatables.net-select-bs4/js/select.bootstrap4.min.js"></script>
